...
const forgotPasswordRequest = (email) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, sendEmail_1.sendEmail)(user.email, "Reset Password Verification Code", `Your OTP code is: ${otp} This code valid for only 5 minutes`);
...
const reSendOtp = (userEmail) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, sendEmail_1.sendEmail)(userEmail, "Account Verification Code", `Your OTP code is: ${OTP} This code valid for only 5 minutes`);
